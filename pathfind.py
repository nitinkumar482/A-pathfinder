    ...
    while not open_set.empty():
        ...
        for neighbors in current.neighbors:
            ...
            if temp_g_score<g_score[neighbors]:
                ...
                g_score[neighbors]=temp_g_score
                f_score[neighbors]=temp_g_score+ h(neighbors.get_pos(),end.get_pos())
                if neighbors not in open_set_hash:
                    count+=1
                    open_set.put((f_score[neighbors],count,neighbors))
                    open_set_hash.add(neighbors)
                    neighbors.make_open()
